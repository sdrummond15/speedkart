    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            <tr>
                    ...
                    if (isset($ag_bookmarks_xml->bookmark)) {
                        foreach ($ag_bookmarks_xml->bookmark as $key => $value) {
                            ...
                            <table border="0" cellspacing="0" cellpadding="0"><tbody><tr>
                                        <td><img src="<?php echo JURI::root() . 'administrator/components/com_admirorgallery/templates/' . $this->ag_template_id . '/images/bookmarkRemove.png'; ?>" style="float:left;" /></td>
                                        <td><input type="checkbox" value="<?php echo $value; ?>" name="AG_cbox_bookmarkRemove[]"></td>
                ...
                <td id="AG_main">
                    <a class="AG_common_button" href="" id="AG_bookmarks_showHide"><span><span><?php echo JText::_('AG_SHOW_SIDEBAR') ?></span></span></a>
